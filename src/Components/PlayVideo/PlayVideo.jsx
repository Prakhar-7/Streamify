  ...
  return (
    <div className="play-video">
      ...
      <div className="play-video-info">
        <p>
          {apiData ? value_converter(apiData.statistics.viewCount) : 'NA'} Views
          &bull;{' '}
          {apiData ? moment(apiData.snippet.publishedAt).fromNow() : 'NA'} ago
        </p>
        <div>
          <span>
            <img src={like} alt="" />
            {apiData ? value_converter(apiData.statistics.likeCount) : 'NA'}
          </span>
          <span>
            <img src={dislike} alt="" />
          </span>
      ...
      <div className="publisher">
        ...
        <div>
          <p>{apiData ? apiData.snippet.channelTitle : 'NA'}</p>
          <span>{channelData?value_converter(channelData.statistics.subscriberCount):"1M"} Subscribers</span>
        </div>
        <button>Subscribe</button>
      </div>
      <div className="vid-description">
        <p>{apiData ? apiData.snippet.description.slice(0, 250) : 'NA'}</p>
        <hr />
        <h4>
          {apiData ? value_converter(apiData.statistics.commentCount) : 'NA'}{' '}
          Comments
        </h4>
